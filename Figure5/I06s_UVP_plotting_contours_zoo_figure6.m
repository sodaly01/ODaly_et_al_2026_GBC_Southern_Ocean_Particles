...
load('C:\Users\steph\OneDrive\Documents\MS_Southern_Ocean\data\zoo_i06s_val_photo_no_fiber_5Sept2024_corr.mat')
...
%             p1 = patch([lat_lon(33:end,1)'  min(lat_lon(33:end,1)) max(lat_lon(33:end,1))], [(bottom_depth(33:end))' 6000 6000] , [0.5 0.5 0.5], 'EdgeColor', 'none');
    ...
    %save figure
    %formatSpec = 'print("D:/G/MS_Southern_Ocean/Zoo_Figures/I06s_multi_panel_Fig6%s_%s", "-djpeg","-r300");';
    %eval(sprintf(formatSpec, plot_type, colorbar_type))
    formatSpec = 'exportgraphics(gcf,"C:/Users/steph/OneDrive/Documents/MS_Southern_Ocean/Figures/I06s_multi_panel_Fig6%s_%s.tif","Resolution",600);';
    eval(sprintf(formatSpec, plot_type, colorbar_type))
    end
    %close all;
end
