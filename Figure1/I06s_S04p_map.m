...
addpath('C:\Users\steph\OneDrive\Documents\Cruises\2018_S04P')

par_s04p = load('C:\Users\steph\OneDrive\Documents\Cruises\2018_S04P\uvp5_sn207_2018_s04p_ecotaxa_export_par2_filtered_AOU_fluor_sitecorrect_flux_loncorr.mat');
%load('S04Ptransectmain.mat')
S04Ptransectmain = load('C:\Users\steph\OneDrive\Documents\Cruises\2018_S04P\S04P_transect_main5.txt');

par_i06s = load('C:\Users\steph\OneDrive\Documents\Cruises\2019_I06S\uvp5_sn207_2019_i06s_tcn322_ecotaxa_export_par2_AOU_fluor_flux_corr.mat');

%load ORSI fronts data
load('C:\Users\steph\OneDrive\Documents\MATLAB\PF_circle.mat')
load('C:\Users\steph\OneDrive\Documents\MATLAB\SACCF_circle.mat')
load('C:\Users\steph\OneDrive\Documents\MATLAB\SAF_circle.mat')
load('C:\Users\steph\OneDrive\Documents\MATLAB\SBDY_circle.mat')
load('C:\Users\steph\OneDrive\Documents\MATLAB\STF_circle')
...
for in = 1:length(S04Ptransectmain)
    ...
    %w2 = find(w1 == 1);
    w2 = find(par_s04p.par.site == S04Ptransectmain(in));
...
set(findall(gca,'Type','text'),'FontWeight','bold')

%print('-dpng','-r300','C:/Users/steph/OneDrive/Documents/MS_Southern_Ocean/Figures/I06s_S04p_map_centered_no_station_fronts_zones_25Sept2025')
% exportgraphics(gcf,'C:/Users/steph/OneDrive/Documents/MS_Southern_Ocean/Figures/I06s_S04p_map_centered_no_station_fronts_zones_10June2026.pdf','ContentType','vector')
% print(gcf,'-dpdf','-vector','C:/Users/steph/OneDrive/Documents/MS_Southern_Ocean/Figures/I06s_S04p_map_centered_no_station_fronts_zones_10June2026_print.pdf')
% exportgraphics(gcf,'C:/Users/steph/OneDrive/Documents/MS_Southern_Ocean/Figures/I06s_S04p_map_centered_no_station_fronts_zones_10June2026.tif','Resolution',600)
% 
% 
% set(gcf,'Renderer','opengl')
% set(gcf,'PaperPositionMode','auto')
% print(gcf,'-dpdf','C:/Users/steph/OneDrive/Documents/MS_Southern_Ocean/Figures/I06s_S04p_map_centered_no_station_fronts_zones_10June2026_600.pdf'); %,'-r600'
