...
bot = readtable("C:/Users/steph/OneDrive/Documents/Cruises/2019_I06S/325020190403_bottle_05Aug2025/325020190403_hy1_removed_flagged_data.xlsx");
bot = bot(2:end-1, :);
...
color_bar_label = {'Temperature (^oC)'; 'Salinity';... % 'Oxygen (\mumol kg^-^1)';
     'AOU (\mumol kg^-^1)';'Beam c_p (m^-^1)'; 'Fluorescence (RFU)'; 'Silicate (\mumol kg^-^1)';...
...
for index1 = 1:4%loop through all categories of particles
   ...
   %plot UVP data over latitude with colorbar created
    ...
    if index1 == 1
        ax4 = axes(fig2, 'Units', 'inches', 'Position', [0.45 5.94 2.75 1.75]); %4.19
    elseif index1 == 2
        ax4 = axes(fig2, 'Units', 'inches', 'Position', [4.03 5.94 2.75 1.75]); %4.19
    elseif index1 == 3
        ax4 = axes(fig2, 'Units', 'inches', 'Position', [0.45 4.19 2.75 1.75]); %2.44
    elseif index1 == 4
        ax4 = axes(fig2, 'Units', 'inches', 'Position', [4.03 4.19 2.75 1.75]); %2.44
    end
    %labels on sigma 2
...
for index1 = 6:8
   for in = 1:length(stations)
    ...
    if index1 == 6 
        cblh.YTick = y; 
        set(cblh,'yticklabel',{'0','2', '4', '5', '10', '35', '40', '42.5', '45',  '60', '80', ''}); %'0','0.5', '1', '5', '10', '20', '22.5', '25', '27.5',  '30', '32.5', ''
    end
    if index1 == 7 
        cblh.YTick = y; 
...
%save figure
print("C:\Users\steph\OneDrive\Documents\MS_Southern_Ocean\Figures\I06s_multi_panel_CTD_Environment_8panel", "-dpng","-r300");
