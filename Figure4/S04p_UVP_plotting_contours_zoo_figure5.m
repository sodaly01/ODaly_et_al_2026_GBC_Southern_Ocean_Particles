...
load('C:\Users\steph\OneDrive\Documents\Cruises\2018_S04P\uvp5_sn207_2018_s04p_ecotaxa_export_par2_filtered_AOU_fluor_sitecorrect_flux_loncorr.mat')
...
load('C:\Users\steph\OneDrive\Documents\MS_Southern_Ocean\data\zoo_s04p_val_photo_no_fiber_20Feb2025.mat')
...
%             end
            ...
            if index1 == 5
                category_label = char('Trichodesmium');
            end
            if index1 == 6
    ...
    %save figure
    %formatSpec = 'print("D:/G/MS_Southern_Ocean/Zoo_Figures/S04P_multi_panel_Fig5%s_%s", "-dpng","-r300");';
    %eval(sprintf(formatSpec, plot_type, colorbar_type))
    formatSpec = 'exportgraphics(gcf,"C:/Users/steph/OneDrive/Documents/MS_Southern_Ocean/Figures/S04P_multi_panel_Fig5%s_%s.tif","Resolution",600);';
    eval(sprintf(formatSpec, plot_type, colorbar_type))
    end
%    close all;
end