...
zoo_summary_new_s04p = readtable('C:\Users\steph\OneDrive\Documents\MS_Southern_Ocean\data\zoo_s04p_val_photo_no_fiber_20Feb2025_summary_mean_new_depth_bins.csv');
...
zoo_summary_new_i06s = readtable('C:\Users\steph\OneDrive\Documents\MS_Southern_Ocean\data\zoo_i06s_val_photo_no_fiber_5Sept2024_summary_mean_new_depth_bins.csv');

%load AOU data
load('C:\Users\steph\OneDrive\Documents\MS_Southern_Ocean\data\Oxygen_sensor\avg_AOU_I06s_S04p_AZ_SZ.mat')
...
t3 = text(1, -1.1, '"Fluffy Aggregate Flux Pathway"', 'FontWeight','Bold','FontSize',10.5,'fontname','helvetica'); %0.0806, -17.3988
...
t3 = text(1, -1.1, '     "Zooplankton-Mediated Flux Pathway"', 'FontWeight','Bold','FontSize',10.5,'fontname','helvetica'); %0.0806, -17.3988
hold off
...
%print('-dpng','-r350', 'D:/G/MS_Southern_Ocean/Figures/stacked_bar_plot_val_all_bz_percent_05June2026');

%print('-dpdf','-vector','C:\Users\steph\OneDrive\Documents\MS_Southern_Ocean/Figures/stacked_bar_plot_val_all_bz_percent_08June2026.pdf');
%%this saved the figure on a standard paper size and didn't preserve the original size

exportgraphics(gcf, 'C:\Users\steph\OneDrive\Documents\MS_Southern_Ocean/Figures/stacked_bar_plot_val_all_bz_percent_08June2026_2.pdf','ContentType','vector')
